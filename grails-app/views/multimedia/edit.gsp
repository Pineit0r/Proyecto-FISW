...
<html>
	...
	<body>
		<a href="#edit-multimedia" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-multimedia" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:multimediaInstance, action:'update']" method="PUT" >
