...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'nombre', 'error')} required">
	...
	<g:field type="text"  name="nombre" class="form-control" required="" value="${usuarioInstance?.nombre}"/>
	</div>
</div>
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'area', 'error')} required">
	...
	<g:select optionValue="nombre"  id="area" class="form-control" name="area.id" from="${proyecto.fisw.Area.list()}" optionKey="id" required="" value="${usuarioInstance.nombre}" class="many-to-one"/>
	</div>
</div>
