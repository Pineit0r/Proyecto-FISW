...
<div class="fieldcontain ${hasErrors(bean: congresoInstance, field: 'nombre', 'error')} required">
	...
	<g:textField name="nombre" required="" value="${congresoInstance?.nombre}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: congresoInstance, field: 'ciudad', 'error')} required">
	...
	<g:select id="ciudad" name="ciudad.id" optionKey="id" optionValue="ciudad" from="${proyecto.fisw.Ciudad.list()}" required="" value="${congresoInstance?.ciudad?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: congresoInstance, field: 'fecha', 'error')} required">
	...
	<g:datePicker name="fecha" precision="day"  value="${congresoInstance?.fecha}"  />
</div>
