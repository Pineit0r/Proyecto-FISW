						...
						<form action='${postUrl}' method='POST' id='loginForm' class='form-signin' autocomplete='off'>
							...
							<div class="form-group">
								...
								<p id="remember_me_holder">
									<input type='checkbox' class='check-box' name='${rememberMeParameter}' id='remember_me' <g:if test='${hasCookie}'>checked='checked'</g:if>/>
							...
							<div id="registerPane" align="center" class="fheader">
								¿No tienes cuenta? <g:link controller="usuario" action="create">Regístrate</g:link>
							</div>
						</form>
					</div>
				</div>
